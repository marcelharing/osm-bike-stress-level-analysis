...
Next, each of the four attributes is given a score. Each attribute type can gain a maximum of 10 points, so the total possible score is 40. I take a heuristic approach, assigning fixed points to each value based on how important this property is for using it comfortably:
...
<img src="https://i.imgur.com/QcPyo9F.png" alt="Stress Level Score Class" width="430"/>
